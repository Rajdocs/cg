...
void startScreen() {
    ...
    displayText(-0.3f, 0.6f, "Bouncing Ball Game");
    displayText(-0.4f, 0.4f, "Team Members:");
    displayText(-0.4f, 0.3f, "1. Adarsh Raj");
    displayText(-0.4f, 0.2f, "2. Bivek Sah");
    displayText(-0.4f, 0.1f, "3. Aman Kumar");
    displayText(-0.4f, 0.0f, "4. Anuradha Verma");
    displayText(-0.3f, -0.2f, "Press ENTER to Start");
}
...
void balldisp() {
    ...
    glLoadIdentity();
    glRasterPos2f(-1, 0.95); // Position score display
    std::string scoreText = "SCORE: " + std::to_string(score);
    displayText(-1, 0.95, scoreText.c_str());
}
